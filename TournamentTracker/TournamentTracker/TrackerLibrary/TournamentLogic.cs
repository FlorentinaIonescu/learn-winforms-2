...
namespace TrackerLibrary
{
    ...
    {
        // Order list randomly
        // Check if big enough, if not add in Bye for a full tournament
        // 2*2*2*2... (2 to the nth power) teams
        // Create first round of matchups
        // Create every round after that
        // (16 teams, 8 matchups -> 8 teams, 4 matchups -> 4 teams, 2 matchups -> 2 teams, 1 matchup)
        ...
        private static void AlertPersonToNewRound(PersonModel p, string teamName, MatchupEntryModel competitor)
        {
            ...
            // TODO list - recheck parameter alignment
            EmailLogic.SendEmail(new List<string>(), new List<string>(), subject, body.ToString());
        }
        ...
        private static int CheckCurrentRound(this TournamentModel model)
        {
            ...
            return output - 1; //ensures the round counter doesn't go past the final round
        }
        ...
        {
            string greaterWinsString = ConfigurationManager.AppSettings["greaterWins"];
            ...
            foreach (MatchupModel m in models)
            {
                ...
                if (m.Entries.Count == 1)
                {
                    ...
                    continue; //a break only for this iteration of the loop
                }
                
                // 0 means false or lower score wins
                if (greaterWinsString == "0")
                {
